...
const flag = "I wondered whether I should DoorDash my food 2025 times, or maybe 41096 times. Not that the number of times matters it's more about whether I'm the one placing the order.";
